                ...
                <div className="share__bottom">
                    <div className="share__bottom-options">
                        <div className="share__bottom-option">
                            <PermMediaIcon htmlColor="tomato" className="share__bottom-icon" />
                            <span className="share__bottom-text">Photo or Video</span>
                        </div>
                        <div className="share__bottom-option">
                            <LabelIcon htmlColor="blue" className="share__bottom-icon" />
                            <span className="share__bottom-text">Tag</span>
                        </div>
                        <div className="share__bottom-option">
                            <PlaceIcon htmlColor="green" className="share__bottom-icon" />
                            <span className="share__bottom-text">Location</span>
                        </div>
                        <div className="share__bottom-option">
                            <EmojiEmotionsIcon htmlColor="goldenrod" className="share__bottom-icon" />
